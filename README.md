...
By the end of deploying this repo you will:
...
2. **Deploy Infrastructure:**  
   Deploy the [CloudFormation template](https://bitbucket.org/imalinovsky/algorithmic-trading/src/main/0_Setup/algo-reference-novpc.yaml) for SageMaker Notebook, Athena, and Glue Tables.  
